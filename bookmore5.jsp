    ...
    <body id="boy1">
        ...
        <%
            ...
            try
            {
                ...
                String sql1="Update buses set seats_rem =seats_rem -"+session.getAttribute("ntickets")+" where bus_id='"+session.getAttribute("bid")+"'";
		        st.executeUpdate(sql1);

                sql1="select seats_rem from buses where bus_id='"+session.getAttribute("bid")+"'";
                ...
                while(rs.next())
                {
                    ...
                    if(x<0)
                    {
                        ...
                        sql1="Update buses set seats_rem =seats_rem+"+session.getAttribute("ntickets")+" where  bus_id='"+session.getAttribute("bid")+"'";
		                st.executeUpdate(sql1);
                    ...
                    else
                    {
                        ...
                        if(session.getAttribute("type").equals("AC"))
                        {
                            ...
                            if(flag==1)
                            {
                                ...
                                sql1="Insert into details ( u_id, date1, bus_id, tickets, TICKET_NO,source,destination,type) values ('"+session.getAttribute("userId")+"','"+session.getAttribute("date2")+"', '"+s+"', '"+session.getAttribute("ntickets")+"','"+m+s+"','"+session.getAttribute("from")+"', '"+session.getAttribute("to")+"', '"+session.getAttribute("type")+"')";
                                st.executeUpdate(sql1);
                            }
                        }
                        ...
                        else
                        {
                            %>
                            <div class="relog_div">
                                <p>Sorry...!  Numbers of seats are lesser.</p>
                            </div>
                            <%
                        }
