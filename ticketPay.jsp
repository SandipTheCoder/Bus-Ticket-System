    ...
    <div id="color-box">
        ...
        <%
            ...
            try
            {
                ...
                session.setAttribute("date2",s3);
                session.setAttribute("ntickets",s4);
                session.setAttribute("bid",s5);
                ...
                String sql1="select * from buses where source = '"+s1+"' and destination = '"+s2+"' and bus_id='"+s5+"' and DATE2='"+s3+"'";
                ...
                while(rs.next())
                {
                    ...
                    {
                        sql1="select * from buses where source = '"+s1+"' and destination = '"+s2+"' and bus_id='"+s5+"' and DATE2='"+s3+"'";
		                rs=st.executeQuery(sql1);
                        ...
                        while(rs.next())
                        {
                            ...
                            %>
                                <div id="divinbox">
                                    ...
                                    <!-- <form action="up1.jsp" method=post> -->
                                        ...
                                        <table id="tab2" cellpadding="10" ,border="2">
                                            ...
                                            <tr>
                                                <td class="td3">
                                                    <div class="input_field">
                                                        <label>Bus ID :</label>
                                                        <label class="input"><% out.println(s5); %> </label><br>
                                                    </div>
                                                </td>
                                                <td class="td2">
                                            ...
                                            <tr>
                                                <td class="td3">
                                                    <div class="input_field">
                                                        ...
                                                        <label class="input"><% out.println(s1);  %></label> <br>
                                                    </div>
                                                </td>
                                                <td class="td2">
                                                    <div class="input1_field">
                                                        <label>To Station :</label>
                                                        <label class="input"><% out.println(s2); %></label><br>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td2">
                                                    <div class="input1_field">
                                                        <label>Date :</label>
                                                        <label class="input"><%out.println(s3); %></label><br>
                                                    </div>
                                                </td>
                                            </tr>
